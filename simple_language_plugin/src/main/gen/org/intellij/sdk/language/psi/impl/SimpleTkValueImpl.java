...
public class SimpleTkValueImpl extends ASTWrapperPsiElement implements SimpleTkValue {

  public SimpleTkValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimpleVisitor visitor) {
    visitor.visitTkValue(this);
  }
