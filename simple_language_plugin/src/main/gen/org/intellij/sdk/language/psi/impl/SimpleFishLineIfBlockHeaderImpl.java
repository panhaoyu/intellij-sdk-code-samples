...
public class SimpleFishLineIfBlockHeaderImpl extends ASTWrapperPsiElement implements SimpleFishLineIfBlockHeader {

  public SimpleFishLineIfBlockHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimpleVisitor visitor) {
    visitor.visitFishLineIfBlockHeader(this);
  }
  ...
  public SimpleKwIf getKwIf() {
    return findNotNullChildByClass(SimpleKwIf.class);
  }
