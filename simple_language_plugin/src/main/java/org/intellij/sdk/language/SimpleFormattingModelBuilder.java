...
final class SimpleFormattingModelBuilder implements FormattingModelBuilder {
    ...
    private static SpacingBuilder createSpaceBuilder(CodeStyleSettings settings) {
        return new SpacingBuilder(settings, SimpleLanguage.INSTANCE)
                ...
                .between(SimpleTokenSets.END_OF_LINE, SimpleTypes.FISH_LINE).spaces(0)
                .between(SimpleTokenSets.END_OF_LINE, SimpleTypes.FISH_DEFINE).spaces(0)
                ...
                // 确保有且只有一个空格
                .aroundInside(SimpleTokenSets.OPERATORS_WITHOUT_MINUS, SimpleTypes.COMMAND_LINE_OTHER_WORDS).spaces(1)  // 运算符前后有空格
                ...
                .around(SimpleTokenSets.OPERATORS_WITHOUT_MINUS).spaces(1)  // 运算符前后有空格
