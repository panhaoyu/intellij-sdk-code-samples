...
public class SimpleElseIfStatementImpl extends ASTWrapperPsiElement implements SimpleElseIfStatement {

  public SimpleElseIfStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
