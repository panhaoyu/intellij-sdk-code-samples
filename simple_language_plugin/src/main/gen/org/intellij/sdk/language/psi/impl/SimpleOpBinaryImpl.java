...
public class SimpleOpBinaryImpl extends ASTWrapperPsiElement implements SimpleOpBinary {

  public SimpleOpBinaryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SimpleVisitor visitor) {
    visitor.visitOpBinary(this);
  }
