...
public class SimpleBlockIfImpl extends ASTWrapperPsiElement implements SimpleBlockIf {

  public SimpleBlockIfImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SimpleBlockElse getBlockElse() {
    return findChildByClass(SimpleBlockElse.class);
  }

  @Override
  @NotNull
  public List<SimpleBlockElseIf> getBlockElseIfList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SimpleBlockElseIf.class);
  }
